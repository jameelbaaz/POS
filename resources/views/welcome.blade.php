...
<head>
  ...
  <title>Eazy Learning Inventory - Dashboard</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Eazy Inventory</div>
      </a>
              ...
              <div class="container my-auto">
                <div class="copyright text-center my-auto">
                  <span>copyright © <script> document.write(new Date().getFullYear()); </script>2022 - developed by
                    <b><a href="https://jameelworks.in" target="_blank">Jameel Ahmed</a></b>
                  </span>
                </div>
              </div>
            </footer>
