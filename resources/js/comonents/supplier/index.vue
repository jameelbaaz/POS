                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr v-for="supplier in suppliers.data" :key="supplier.id">
                        ...
                        <td><img :src="supplier.photo" alt="supplier" class="em_photo"></td>
                        <td>{{supplier.shopname}}</td>
                        <td>{{supplier.email}}</td>
                        <td>
                          <router-link  :to="{name:'edit-supplier',params:{id:supplier.id}}" class="btn btn-sm btn-primary text-white">Edit</router-link>
...
getResults(page=1) { 
        ...
        axios.get(`/api/supplier?page=${page}&search=${this.search}`) 
